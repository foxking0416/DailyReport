...
{
    public partial class OutsourceSearchForm : SearchFormBase
    {
        private OutsourceEditForm editForm;
        private string[] units;

        public OutsourceSearchForm(OutsourceEditForm form, MySQL Sql) 
            : base(Sql)
        {
            InitializeComponent();
            editForm = form;
            InitializeOutsourceSearchForm();
            Initialize();
        }

        public OutsourceSearchForm(DailyReportIncreaseForm form, int row, int column, MySQL Sql) 
            : base(Sql)
        {
            nFormType = 1;
            nRowIndex = row;
        ...
        private void InitializeOutsourceSearchForm()
        {
            this.Text = "搜尋材料";
            this.strDataBaseTableName = "Outsource";
